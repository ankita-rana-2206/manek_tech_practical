...
class _CartPageState extends State<CartPage> {
        ...
        builder: (context, orientation) {
          return Column(
            children: [
              ...
              Expanded(child: _getCartList(_appTheme,orientation)),
  ...
  Widget _getCartList(AppThemeState _appTheme, Orientation orientation) {
            ...
            return snapshot.data!.isNotEmpty
                ? ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return _getCartItem(_appTheme, snapshot.data?[index], orientation);
                    })
  ...
  Widget _getCartItem(AppThemeState _appTheme, Cart? cart, Orientation orientation) {
      ...
      child: Row(
        ...
        children: [
          Container(
            ...
            height: _appTheme.getResponsiveHeight(orientation == Orientation.portrait ? 150 : 350),
            decoration: BoxDecoration(
