...
class _ProductPageState extends State<ProductPage> {
      ...
      return Scaffold(
        appBar: PreferredSize(
          ...
          child: CommonAppBar(
            ...
            centerTitle: true,
            actions: [_getTitleCartIcon(_appThemeState, orientation)],
          ),
        ),
        body: Container(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    _getCartIcon(_appTheme, product, orientation),
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    _getSizedBox(_appTheme, width: 30),
                    _getCartIcon(_appTheme, product, orientation),
                  ],
                ),
                _getSizedBox(_appTheme, height: 10),
  ...
  Widget _getCartIcon(
    ...
    return InkWell(
      child: SvgPicture.asset(
        ...
        color: _appTheme.blackColor,
        width: _appTheme
            .getResponsiveWidth(orientation == Orientation.portrait ? 30 : 100),
        height: _appTheme.getResponsiveHeight(
            orientation == Orientation.portrait ? 30 : 100),
      ),
      onTap: () {
        AppComponentBase.getInstance()
          ...
          Fluttertoast.showToast(
              msg: StringConstants.productAdded,
  ...
  Widget _getTitleCartIcon(AppThemeState _appTheme, Orientation orientation) {
    return Container(
      ...
      child: InkWell(
        child: SvgPicture.asset(
          ...
          width: _appTheme.getResponsiveWidth(
              orientation == Orientation.portrait ? 30 : 100),
          height: _appTheme.getResponsiveHeight(
              orientation == Orientation.portrait ? 30 : 100),
        ),
